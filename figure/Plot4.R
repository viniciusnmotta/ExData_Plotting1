...
plot(df2$V10,df2$Global_active_power,type="l",xlab="",ylab="Global Active Power")
...
plot(df2$V10,df2$Voltage,xlab="datetime",ylab="Voltage",type="l")
plot(df2$V10,df2$Global_reactive_power,xlab="datetime",ylab="Global Reactive Power",type="l")
dev.off()
